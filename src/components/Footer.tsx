    ...
    <footer className="bg-primary text-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div>
            <h3 className="font-serif font-semibold text-lg md:text-xl mb-3 md:mb-4">Os Rostos de Camões</h3>
          ...
          <div>
            <h4 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">Informações do Evento</h4>
            <div className="space-y-2 md:space-y-3 text-light/80">
              <div className="flex items-center space-x-2">
                <Calendar size={14} className="md:w-4" />
                <span className="text-xs md:text-sm">20 de Junho a 2 de Agosto</span>
              </div>
              <div className="flex items-center space-x-2">
                <Clock size={14} className="md:w-4" />
                <span className="text-xs md:text-sm">10h - 17h30 | Segunda a Sábado</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin size={14} className="md:w-4" />
                <span className="text-xs md:text-sm">Camões CLP, Casa Basílio Dias, Rua Dr. Brito Câmara, Goa 403 001</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1 md:space-y-2 text-light/80">
              <p className="text-xs md:text-sm">Rua Dr. Brito Câmara, Goa 403 001</p>
